...
LLD dataset [1] contains various logo dataset with different amount and resolution of logo in which we have chosen two of the datasets provided:
...
The following are the specifications of computer/VM instances used for training DCGAN:<br><br><br>
